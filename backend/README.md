...
## Project Structure
    ...
    ├── testapiautosettingswpyj_1  # Django project configurations
...
1. Clone this repo and `cd testapiautosettingswpyj_1`
...
2. Clone this repo and `cd testapiautosettingswpyj_1`
